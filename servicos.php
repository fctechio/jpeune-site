  ...
  <main>
    <section class="page-hero">
      <div class="container">
        ...
        <h1 class="page-hero__title" data-fade>Serviços</h1>
    ...
    <section class="content-section" aria-label="Nossas soluções">
      <div class="container">
        <div class="text-center" style="margin-bottom: 3rem;">
          <span class="section-label" data-fade>O que oferecemos</span>
          <h2 style="margin-bottom: .75rem;" data-fade data-delay="100">Nossas Soluções</h2>
          <p style="max-width: 600px; margin: 0 auto;" data-fade data-delay="200">
            Cada solução foi desenhada para atuar em uma etapa crítica da gestão do contencioso, de forma integrada ou independente.
          </p>
        </div>
        ...
        <div class="service-large-grid">
          ...
          <div class="service-large-card" data-fade>
            ...
            <div class="service-large-card__title">Célula de Acordos</div>
          ...
          <div class="service-large-card" data-fade data-delay="100">
            ...
            <div class="service-large-card__title">Diagnóstico Estratégico de Passivos</div>
            <p class="service-large-card__desc">
          ...
          <div class="service-large-card" data-fade data-delay="200">
            ...
            <div class="service-large-card__title">Integração de Dados e Estratégia Jurídica</div>
            <p class="service-large-card__desc">
          ...
          <div class="service-large-card" data-fade data-delay="300">
            ...
            <div class="service-large-card__title">Gestão de Ciclos</div>
            <p class="service-large-card__desc">
